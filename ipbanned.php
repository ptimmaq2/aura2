...
<link rel="stylesheet" href="{url}/app/tpl/skins/aura/css/v3_default.css" type="text/css" />
...
<a href="{url}/banned"><input style="margin-right: 20px;float:right;" class="confirm-button" type="submit" value="You are banned" /></a></div>
            <div class="navigation">
                <ul>
                        <li class="selected">
                            <a href="http://google.com/"><span class="community"></span>BANNED!</a>
                            <span></span>
                        </li>
...
<div id="content">
  ...
  <div id="page-content">
    ...
    <div class="loyalty-header">
        <h1 class="underlined">You are banned.</h1>
    </div>
    <section id="upper-content-left">
        <h2>What's this?</h2>
        <p>You have been banned by some {hotelname} staff. Most likely, because of not obeying rules.</p>
		
		<p> <a href="http://google.com/">Click here if you want to leave.</a></p>

 
</section>


 <img src="{url}/app/tpl/skins/{skin}/images/banned/2.png" style="background:white;border-radius:10px;border:1px solid black:" />
</div></div></div>


<script src="https://habboo-a.akamaihd.net/habboweb/63_1dc60c6d6ea6e089c6893ab4e0541ee0/2543/web-gallery/static/js/v3_default_bottom.js" type="text/javascript"></script>
<!--[if IE]><script src="https://habboo-a.akamaihd.net/habboweb/63_1dc60c6d6ea6e089c6893ab4e0541ee0/2543/web-gallery/static/js/v3_ie_fixes.js" type="text/javascript"></script>
<![endif]-->
