...
<a href="{url}/register"><input style="margin-right: 0px;float:right;" class="signout-red-button" type="submit" value="Register" /></a>      
            <div class="navigation">
                <ul>
                        <li>
                            <a href="{url}/me"><span class="community"></span> Me</a>
                            <span></span>
                        </li>
                        <li>
                            <a href="{url}/community"><span class="safety"></span> Community</a>
                            <span></span>
                        </li>
						 <li>
...
<div id="content">
  ...
  <div id="page-content">
    ...
    <div class="loyalty-header">
        <h1 class="underlined">You Have Successfully Signed Out.</h1>
    </div>
    <section id="upper-content-left">
        <h2>What's this?</h2>
        <p>You Signed out of {hotelname} (or your session has expired.)</p>
		<a href="{url}/index"><input style="margin-right: 20px;float:right;" class="confirm-button" type="submit" value="Go to Hotel's frontpage." /></a>

 
</section>

 <img src="{url}/app/tpl/skins/{skin}/img/404.gif" /> </div>
    </div>
</div>
